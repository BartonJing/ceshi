...
<script type="text/javascript">
	var currentPage = ${imgPageModel.getCurrentPage()};
	var total = ${imgPageModel.getTotalPage()};
	/* 下一页 */
	function nextPage() {
		if (currentPage < total) {
			currentPage++;
			window.location.href = "/XSF/product/openimageMana.action?currentPage="
					+ currentPage;
		} else {
			alert("已经是最后一张了！");
			return;
...
<body>
<s:iterator value="#request.imgPageModel.getData()">
	<form action="/XSF/product/editorimageMana?i_id=${i_id}" method="post" enctype="multipart/form-data">
	<div class="form_main">
		...
		<div class="myform">
			...
			<button><a href="/XSF/product/deleteimage?i_id=${i_id}">删除</a></button>
		...
		<div style="font-size: 16px; float: right">
			第${imgPageModel.getCurrentPage()}张/共${imgPageModel.getTotalPage()}张
